      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Lensroom</h3>
              <p>Developed a sleek and responsive photography service website using React.js.
                 Designed to showcase portfolios, manage bookings, and provide seamless navigation for users.
                 Implemented dynamic galleries, client testimonials, and an intuitive contact form.
                 Ensured high performance, cross-browser compatibility, and a modern user experience.
              </p>
            </div>
            <footer> <ul className="tech-list"> <li>React</li></ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>Programmed a customized tax calculator relating income ,age groups and various other criteria.
                 Developed with JavaScript to define all the logics user friendly interface with clear instructions.
                 Implemented GSAP(green sock animation platform)at the landing page for smooth animation and seamless user experience.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>Crafted a customized educational website on Wix technology.
                 Made the required customized eye catching components rather than predefined one.
                 Developed interactive maps ,event calendars and mobile-friendly design ,which makes your international academic journey at your finger tips.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
